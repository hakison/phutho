...
install_projectivy() {
    ...
    local list_xs_a14=(
        ...
        # ĐÃ SỬA: Đổi sang Activity chuẩn .MainActivity để TV khóa cứng phím Home vào bộ cài tiếng Việt
    ...
    # Đưa các lệnh tối ưu hóa cấu hình cài đặt gốc xuống dưới sau khi đã thông quyền Secure Settings
    for cmd_sys in \
